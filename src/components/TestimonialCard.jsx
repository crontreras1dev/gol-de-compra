...
export function TestimonialCard ({ name, rate, quote, location }) {
  return (
    <div className="bg-card border border-border rounded-xl p-7 md:p-8 flex flex-col">
      <div className="flex items-center gap-1 mb-5">
        <p className="w-4 h-4 fill-primary text-primary">{rate}</p>
      </div>
      ...
      <div className="mt-auto flex items-center gap-3 pt-5 border-t border-border">
        ...
        <div>
          <div className="font-medium text-main-text">{name}</div>
